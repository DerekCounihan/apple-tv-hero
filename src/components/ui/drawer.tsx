...
const DrawerTrigger =
  DrawerPrimitive.Trigger as React.FC<
...
const DrawerClose =
  DrawerPrimitive.Close as React.FC<
...
>(
  (
    ...
    // Default: show close button when handle is hidden (unless explicitly set)
    const shouldShowCloseButton = showCloseButton ?? !showHandle;
    ...
    return (
      <DrawerPortal>
        ...
        >
          ...
          {shouldShowCloseButton && !showHandle && (
